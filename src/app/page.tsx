...
const styles = {
  ...
  cardBtn: { background: "#161616", border: "1px solid #222", padding: "25px", borderRadius: "20px", display: "flex", alignItems: "center", gap: "20px", cursor: "pointer", color: "#fff", transition: "all 0.2s ease" },
  ...
  btnTitle: { fontSize: "17px", color: "#fff", fontWeight: "bold" as const },
  btnDesc: { fontSize: "12px", color: "#666" },
  ctaSection: { maxWidth: "500px" },
  description: { fontSize: "18px", color: "#888", marginBottom: "30px" },
  ctaButtons: { display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" as const },
